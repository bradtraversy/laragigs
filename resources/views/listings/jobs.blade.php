...
<div class="ac"></div>
<div class="right order-2 justify-start ">


<div class="con-header">
    <h1 class="text-3xl text-white-50">Trending Jobs</h1>
    <ol class="justify-start text-white-50">
...
<div class="con-header">
    <h1 class="text-3xl text-white-50">Top Job Countries</h1>
...
<div class="con-header">
    <h1 class="text-3xl text-white-50">Trending Blogs</h1>
  ...
  <div class="con-header items-start">
    <h1 class="text-3xl text-white-50">Our Services</h1>
    <ol class="text-white-50">
